...
class G1RobotPresets:
    ...
    @classmethod
    def g1_29dof_inspire_base_fix(cls,init_pos: Tuple[float, float, float] = (4.7, -0.21, -0.6),
        init_rot: Tuple[float, float, float, float] = (0, 0, 0, 0.7071)) -> ArticulationCfg: #0.7071
