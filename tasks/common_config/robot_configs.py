...
from robots.unitree import G129_CFG_WITH_DEX1_BASE_FIX,G129_CFG_WITH_DEX3_BASE_FIX, G1_CFG
...
class G1RobotJointTemplates:
    ...
    @classmethod
    def get_hand_joints(cls, hand_type: Literal["gripper", "dex3", "ftp"] = "gripper") -> Dict[str, float]:
        ...
        if hand_type == "gripper":
            ...
            raise ValueError(f"Unsupported hand type: {hand_type}. Supported: 'gripper', 'dex3', 'ftp'")
...
class G129dofRobotBaseCfg:
    ...
    def get_base_config(
        ...
        hand_type: Literal["gripper", "dex3", "ftp"] = "gripper",
        base_config = None,
