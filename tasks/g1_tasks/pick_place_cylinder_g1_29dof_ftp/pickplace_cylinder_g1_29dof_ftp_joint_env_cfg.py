...
class ObjectTableSceneCfg(TableCylinderSceneCfg):
    ...
    robot: ArticulationCfg = G1RobotPresets.g1_29dof_ftp_base_fix()
    # 6. add camera configuration 
    front_camera = CameraPresets.g1_front_camera()
    #left_wrist_camera = CameraPresets.left_ftp_wrist_camera()
    #right_wrist_camera = CameraPresets.right_ftp_wrist_camera()
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        robot_gipper_state = ObsTerm(func=mdp.get_robot_ftp_joint_states)
...
@configclass
class PickPlaceG129FTPJointEnvCfg(ManagerBasedRLEnvCfg):
