...
class H1RobotDDS(DDSObject):
    """G1 robot DDS communication class - singleton pattern
    
    Features:
    - Publish the state of the H1 robot to DDS (rt/lowstate)
    - Receive the control command of the G1 robot (rt/lowcmd)
    """
    
    def __init__(self,node_name:str="h1_robot"):
        """Initialize the H1 robot DDS node"""
        ...
        print(f"[{self.node_name}] H1 robot DDS node initialized")
